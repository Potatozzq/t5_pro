...
# need to be change to appropriate path because I used absolute path here
data_path = 'C:/Users/potato/Desktop/t5_pro/webnlg-dataset-master-release_v3.0/release_v3.0/en/'   #1
#outdir = 'data/webnlg_pos_ordered'
outdir = 'C:/Users/potato/Desktop/t5_pro/T5_large/data/webnlg20_ordered'  #1
...
def convert_dataset(pair_src, pair_tgt, b):
    wf_src = open(pair_src, 'w', encoding='utf-8')
    wf_tgt = open(pair_tgt, 'w', encoding='utf-8')
    max_role = 4
    max_tree = 1
...
def convert_dataset_test(pair_src, pair_tgt, b):
    wf_src = open(pair_src, 'w', encoding='utf-8')
    wf_tgt = open(pair_tgt, 'w', encoding='utf-8')
    wf_tgt1 = open(pair_tgt + '_eval', 'w', encoding='utf-8')
    wf_tgt2 = open(pair_tgt + '2_eval', 'w', encoding='utf-8')
    wf_tgt3 = open(pair_tgt + '3_eval', 'w', encoding='utf-8')
    max_role = 4
    max_segment = 1
    max_order = 1
    max_tree = 1
...
files = select_files(data_path+'train')    #1
...
files = select_files(data_path+'dev')    #1
b.fill_benchmark(files)
...
files = [(data_path+'test', 'rdf-to-text-generation-test-data-with-refs-en.xml')]
b.fill_benchmark(files)
